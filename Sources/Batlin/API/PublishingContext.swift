...
public struct PublishingContext<Site: Website> {
    ...
    public var parsleyParser = ParsleyMarkdownParser()
...
internal extension PublishingContext {
    ...
    func makeMarkdownContentFactory() -> InkMarkdownContentFactory<Site> {
        InkMarkdownContentFactory(
            parser: markdownParser,
            dateFormatter: dateFormatter
        )
    }
    func makeTextbundleContentFactory(context: PublishingContext<Site>, targetFolderPath: Path? = nil) -> TextbundleContentFactory<Site> {
        TextbundleContentFactory(
            parser: parsleyParser, 
            dateFormatter: dateFormatter,
            context: context,
            targetFolderPath: targetFolderPath
        )
    }
    func makeParselyContentFactory() -> ParsleyMarkdownContentFactory<Site> {
        ParsleyMarkdownContentFactory(
            parser: parsleyParser, 
            dateFormatter: dateFormatter
        )
    }
